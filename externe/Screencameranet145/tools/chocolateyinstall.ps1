...
$fileLocation = Join-Path $toolsDir 'Screencameranet145setup.exe'
...
$url        = 'http://www.cyberdev.be/choco/Screencameranet145Setup.exe' # download url, HTTPS preferred
$url64      = 'http://www.cyberdev.be/choco/Screencameranet145Setup.exe' # 64bit URL here (HTTPS preferred) or remove - if installer contains both (very rare), use $url
...
$packageArgs = @{
  ...
  softwareName  = 'Screencameranet145*' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique
