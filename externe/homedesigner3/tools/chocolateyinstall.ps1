...
#$fileLocation = Join-Path $toolsDir 'ashampoo_home_designer_pro_3_3.3.0_sm.exe'
...
$url        = 'https://www.cyberdev.be/choco/ashampoo_home_designer_pro_3_3.3.0_sm.exe' # download url, HTTPS preferred
$url64      = 'https://www.cyberdev.be/choco/ashampoo_home_designer_pro_3_3.3.0_sm.exe' # 64bit URL here (HTTPS preferred) or remove - if installer contains both (very rare), use $url
...
$packageArgs = @{
  ...
  softwareName  = 'homedesigner3*' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique
