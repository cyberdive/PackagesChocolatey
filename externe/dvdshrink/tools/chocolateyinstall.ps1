...
#$fileLocation = Join-Path $toolsDir 'dvdshrink32setup_FR'
...
$url        = 'http://www.cyberdev.be/choco/dvdshrink32setup_FR.exe' # download url, HTTPS preferred
$url64      = 'http://www.cyberdev.be/choco/dvdshrink32setup_FR.exe' # 64bit URL here (HTTPS preferred) or remove - if installer contains both (very rare), use $url
...
$packageArgs = @{
  ...
  softwareName  = 'dvdshrink*' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique
